export function renderWorkspace() {
  return `
    <main class="main-view" id="main-view">
      ...
      <!-- RESULT -->export function renderWorkspace() {
  return `
    <main class="main-view" id="main-view">
      ...
      <div id="result-state">
        ...
        <div class="verdict-hero" id="verdict-hero">
          ...
          <div class="hero-text">
            <h2 id="hero-title">UNKNOWN</h2>
            <p id="hero-sub">Awaiting analysis completion.</p>
          </div>
        </div>
        ...
        <div class="summary-container">
          <div class="summary-title"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="22" y1="12" x2="2" y2="12"></line><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path><line x1="6" y1="16" x2="6.01" y2="16"></line><line x1="10" y1="16" x2="10.01" y2="16"></line></svg> Evidence Summary</div>
          <div class="summary-grid">
            <div class="sum-item"><span class="sum-label"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg> Signal Analysis</span><span class="sum-val" id="sum-signal">Pending</span></div>
            <div class="sum-item"><span class="sum-label"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg> File SHA-256</span><span class="sum-val" id="sum-sha">Pending</span></div>
            <div class="sum-item"><span class="sum-label"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path></svg> Embedding</span><span class="sum-val" id="sum-embedded">Pending</span></div>
          </div>
        </div>

        <!-- 4. Format Metrics Row -->
        ...
        <!-- Download Banner -->
        <div id="download-bar">
          <p><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><polyline points="20 6 9 17 4 12"></polyline></svg> CRYPTOGRAPHIC SIGNATURE APPLIED</p>
        ...
        <div class="json-panel">
          <button class="json-toggle" id="json-toggle">
            <span style="display:flex;align-items:center;gap:8px;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg> RAW MANIFEST JSON</span>
